...
Each hunt closure writes one YAML file here. The `peak-hunt` agent reads all
...
```
HUNT-YYYYMMDD-<slug>.yaml
```

Example: `HUNT-20260801-apt40-cloud-token-abuse.yaml`
...
At the start of PREPARE, the agent scans all YAML files and checks:
